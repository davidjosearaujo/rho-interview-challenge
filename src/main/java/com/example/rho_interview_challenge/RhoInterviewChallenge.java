...
public class RhoInterviewChallenge {
   ...
   public static void main(String[] args) {
	...
	// If currency parameter is not provided, return all exchange rates for currency A in the path variable
	// If multiple currencies parameters are provided, return a list of exchange rates to each currency
	...
	public ResponseEntity<Object> getRate(@PathVariable("id") String id, @RequestParam(required = false) List<String> currency) {
	...
	// If multiple currencies parameters are provided, return a list of values in each currency
	// If the currency is not found, return an error
	...
	public ResponseEntity<Object> getValue(@PathVariable("id") String id, @PathVariable("amount") String amount, @RequestParam(required = false) List<String> currency) {
		return new ResponseEntity<>("Hi", HttpStatus.OK);
	}
}